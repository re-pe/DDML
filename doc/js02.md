...
# Variantas 1. JavaScript. Savybės perteikiamos objekto metodais

## Pavyzdys

```js
// JavaScript, savybės perteikiamos objekto metodais
let htmlDoc = HtmlDoc(
    doctype("html"),
    html().lang("en").$(,
        head(
        ...
        body(
            main(
                header("@py-10@bg-gray-300",
                    h1("@text-4xl@text-center", "kdl - Kat's Document Language"),
                ),
                section("@kdl-section#description",
                    p(
                        "kdl is a document language, mostly based on ",
                        a("SDLang").href("https://sdlang.org"),
                ...
                section("@kdl-section#design-and-discussion",
                    ...
                    p(
                        ...
                        a().href("https://github.com/kdoclang/kdl/discussions").$("discussions"),
