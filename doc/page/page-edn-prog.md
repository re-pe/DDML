...
Realizuotas kaip kaip functijų iškvietimas, parametrus perteikiant kaip „map'us“.

```clojure
;; kaip programa, kuri gali grąžinti kad ir struktūrą iš page-html-data.edn failo
