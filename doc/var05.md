...
Pagrindas - 2 variantas

## Pavyzdys

```text
$;; Modifikuota ir invertuota KDL sintakse
...
$;; skliausteliai "[" ir "]" grupuoja reikšmes, taip pat ir esančias skirtingose eilutėse
    ...
    $body [
        $main [
            ...
            $section .class="kdl-section" .id="description" [
                ...
                $;; Anoniminis paragrafas, išskiriamas tuščia eilute prieš ir po
